...
const THEFT_PREVENTION_INTEGRATIONS = [
  ...
  {
    name: 'Stolen Register',
    icon: '📋',
    description: 'Free stolen item database with partial serial number search. Covers equipment, tools, and machinery.',
    status: 'available',
    url: 'https://www.stolenregister.com/check',
    actionLabel: 'Check Free',
  },
  {
    name: 'NMVTIS / AAMVA',
    icon: '🪪',
  ...
  },
  {
    name: 'NER IRONcheck',
    icon: '🔎',
    description: '20M+ theft & ownership records — most comprehensive stolen equipment database in North America. $79.95/search.',
    status: 'available',
    url: 'https://www.ner.net/solutions/ironcheck/',
    actionLabel: 'Search',
  },
  {
    name: 'MachineryTrader Stolen',
    icon: '🏗️',
    description: 'Free crowd-sourced stolen equipment listings. Search by make/model/serial number.',
    status: 'available',
    url: 'https://www.machinerytrader.com/stolen-equipment/search',
    actionLabel: 'Search Free',
  },
  {
