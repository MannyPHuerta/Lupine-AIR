...
export default function StoreHeader({ storeMode = 'both' }) {
  return (
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-xs text-gray-400">
              {storeMode === 'both' ? 'Construction & Event Rentals' : storeMode === 'events_only' ? 'Event Rentals' : 'Equipment Rentals'}
            </div>
          </div>
        </div>
