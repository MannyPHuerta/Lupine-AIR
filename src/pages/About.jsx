  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-blue-700 text-white px-4 py-3 flex items-center gap-2 shadow-md">
        <Button variant="ghost" size="icon" className="text-white hover:bg-blue-600" onClick={() => navigate("/report-form")}>
      ...
      <div className="max-w-xl mx-auto p-6 space-y-6">
        <div className="flex justify-center">
          <img src="https://media.base44.com/images/public/69deb9b2f06f1355a056f8e0/7bc9512a2_wolf_silhouette.png" className="w-28 h-28 rounded-lg object-cover shadow-md" alt="Asset Wolf" />
        </div>
