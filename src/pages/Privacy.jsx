export default function Privacy() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 text-gray-800">
      ...
      <p className="text-sm text-gray-500 mb-8">AIR by Lupine | Effective Date: April 25, 2025</p>

      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">1. Overview</h2>
        <p>This Privacy Policy describes how Lupine Technologies ("we," "us," or "our") collects, uses, and protects information through the AIR rental equipment platform. This application is used by authorized rental businesses and their staff.</p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-5 space-y-1 mt-1">
          <li>Authorized staff members of your rental business as part of normal operations</li>
      ...
      <section className="mb-6">
        ...
        <p>Access to the AIR platform is restricted to authenticated users with valid credentials. All data is stored securely and access is logged.</p>
      </section>

      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">7. Contact</h2>
        <p>For questions about this privacy policy, contact <a href="mailto:info@TheProjectAIR.com" className="text-blue-600 underline">info@TheProjectAIR.com</a>.</p>
      </section>
