  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 pt-4 flex items-center justify-between">
        <button className="flex items-center gap-1 text-blue-700 font-medium hover:underline" onClick={() => navigate("/report-form")}>
          <ArrowLeft className="w-5 h-5" />
          <span className="text-sm">Back</span>
        </button>
        <div className="flex items-center gap-3">
          <span className="text-xs text-gray-500">{filtered.length} report{filtered.length !== 1 ? "s" : ""}</span>
          <button className="flex items-center gap-1 text-blue-700 font-medium hover:underline" onClick={exportCSV}>
          ...
          {canPostToMarketplace && (
            <button className="flex items-center gap-1 text-blue-700 font-medium hover:underline" onClick={() => navigate("/analytics")}>
